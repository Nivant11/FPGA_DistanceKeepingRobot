...
REM
REM Generated by Vivado on Fri Aug 12 13:21:39 -0400 2022
...
echo "xvlog --incr --relax -prj Robot_top_tb_vlog.prj"
call xvlog  --incr --relax -prj Robot_top_tb_vlog.prj -log xvlog.log
