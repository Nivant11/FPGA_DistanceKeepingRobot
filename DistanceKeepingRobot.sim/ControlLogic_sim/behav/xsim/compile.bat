...
REM
REM Generated by Vivado on Mon Aug 08 16:42:11 -0400 2022
...
echo "xvlog --incr --relax -prj ControlLogic_tb_vlog.prj"
call xvlog  --incr --relax -prj ControlLogic_tb_vlog.prj -log xvlog.log
