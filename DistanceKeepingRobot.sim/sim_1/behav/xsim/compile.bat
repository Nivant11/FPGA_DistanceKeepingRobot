...
REM
REM Generated by Vivado on Tue Jul 19 20:42:07 -0400 2022
...
echo "xvlog --incr --relax -prj SensorControl_tb_vlog.prj"
call xvlog  --incr --relax -prj SensorControl_tb_vlog.prj -log xvlog.log
