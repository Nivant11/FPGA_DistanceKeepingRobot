...
REM
REM Generated by Vivado on Sun Jul 24 23:58:11 -0400 2022
...
echo "xvlog --incr --relax -prj PWMController_tb_vlog.prj"
call xvlog  --incr --relax -prj PWMController_tb_vlog.prj -log xvlog.log
